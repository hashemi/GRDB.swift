    ...
    func testSingleColumnNoForeignKeyNoPrimaryKey() throws {
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                try assertSQL(db, Child.all().joined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" JOIN \"parents\" ON (\"parents\".\"rowid\" = \"children\".\"parentId\")")
                try assertSQL(db, Child.all().leftJoined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" LEFT JOIN \"parents\" ON (\"parents\".\"rowid\" = \"children\".\"parentId\")")
            ...
            do {
                ...
                try assertSQL(db, Child.all().joined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" JOIN \"parents\" ON (\"parents\".\"id\" = \"children\".\"parentId\")")
                try assertSQL(db, Child.all().leftJoined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" LEFT JOIN \"parents\" ON (\"parents\".\"id\" = \"children\".\"parentId\")")
    ...
    func testSingleColumnSeveralForeignKeys() throws {
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                try assertSQL(db, Child.all().joined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" JOIN \"parents\" ON (\"parents\".\"id\" = \"children\".\"parent1Id\")")
                try assertSQL(db, Child.all().leftJoined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" LEFT JOIN \"parents\" ON (\"parents\".\"id\" = \"children\".\"parent1Id\")")
                try assertSQL(db, Child().makeRequest(association), "SELECT * FROM \"parents\" WHERE (\"id\" = 1)")
            }
            do {
            ...
            do {
                ...
                try assertSQL(db, Child.all().joined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" JOIN \"parents\" ON (\"parents\".\"id\" = \"children\".\"parent2Id\")")
                try assertSQL(db, Child.all().leftJoined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" LEFT JOIN \"parents\" ON (\"parents\".\"id\" = \"children\".\"parent2Id\")")
    ...
    func testCompoundColumnNoForeignKeyNoPrimaryKey() throws {
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                try assertSQL(db, Child.all().joined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" JOIN \"parents\" ON ((\"parents\".\"a\" = \"children\".\"parentA\") AND (\"parents\".\"b\" = \"children\".\"parentB\"))")
                try assertSQL(db, Child.all().leftJoined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" LEFT JOIN \"parents\" ON ((\"parents\".\"a\" = \"children\".\"parentA\") AND (\"parents\".\"b\" = \"children\".\"parentB\"))")
    ...
    func testCompoundColumnSeveralForeignKeys() throws {
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                try assertSQL(db, Child.all().joined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" JOIN \"parents\" ON ((\"parents\".\"a\" = \"children\".\"parent1A\") AND (\"parents\".\"b\" = \"children\".\"parent1B\"))")
                try assertSQL(db, Child.all().leftJoined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" LEFT JOIN \"parents\" ON ((\"parents\".\"a\" = \"children\".\"parent1A\") AND (\"parents\".\"b\" = \"children\".\"parent1B\"))")
                try assertSQL(db, Child().makeRequest(association), "SELECT * FROM \"parents\" WHERE ((\"a\" = 1) AND (\"b\" = 2))")
            }
            do {
            ...
            do {
                ...
                try assertSQL(db, Child.all().joined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" JOIN \"parents\" ON ((\"parents\".\"a\" = \"children\".\"parent2A\") AND (\"parents\".\"b\" = \"children\".\"parent2B\"))")
                try assertSQL(db, Child.all().leftJoined(with: association), "SELECT \"children\".*, \"parents\".* FROM \"children\" LEFT JOIN \"parents\" ON ((\"parents\".\"a\" = \"children\".\"parent2A\") AND (\"parents\".\"b\" = \"children\".\"parent2B\"))")
